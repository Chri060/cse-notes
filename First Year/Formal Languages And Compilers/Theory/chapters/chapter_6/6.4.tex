...
\begin{definition}[\textit{Dependence graph of a semantic function}]
...
\end{definition}
\begin{definition}[\textit{Dependence graph of a production $p$}]
...
\end{definition}
\begin{definition}[\textit{Dependence graph of a decorated syntax tree}]
...
\begin{property}[\textit{Correct attribute grammar}]
