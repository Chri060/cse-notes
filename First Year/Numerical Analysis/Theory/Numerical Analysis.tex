...
\newtheorem[M]{corollary}{Corollary}[chapter]
\newtheorem[M]{lemma}{Lemma}[chapter]
\newtheorem[S]{definition}{Definition}
...
\chapter{Nonlinear equations}
    ...
    \begin{theorem}[Theorem of zeros of continuous functions]
