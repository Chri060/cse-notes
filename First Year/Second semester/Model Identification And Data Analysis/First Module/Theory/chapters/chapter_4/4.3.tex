...
\begin{align*}
    \mathbb{E}\left[ {\left(\varepsilon(t+k|t)\right)}^2 \right]  &= \mathbb{E}\left[ {\left(\sum_{i=0}^{k-1}w_j e(t+k-i)+\sum_{i=0}^{+\infty}w_{k+i}e(t-i)-\sum_{i=0}^{+\infty}\beta_i e(t-1)\right)}^2 \right] \\
